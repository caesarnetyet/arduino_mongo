...
temp = Sensor(pin_in=17, tipo="temp",  id_="temp1", description="Detector de humedad para el bote")
hum = Sensor(pin_in=17, tipo="hum",  id_="hum1", description="Detector de humedad para el bote")
