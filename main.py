...
temp = Adafruit(pin=2, tipo="temp",  id_="temp1", description="Detector de humedad para el bote")
hum = Adafruit(pin=21, tipo="hum",  id_="hum1", description="Detector de humedad para el bote")
